 ...
 */ !(function (i) {
     ...
     */ !(function (t, n) {
          ...
          function (e, t) {
            k.fn[e] = function (n, r) {
              ...
              return (
                ...
                this.length > 1 &&
                  (R[e] || k.uniqueSort(i), P.test(e) && i.reverse()),
                this.pushStack(i)
              );
            };
          }
            ...
            var t = [
              ...
              i = {
                ...
                then: function (e, r, i) {
                  ...
                  return k
                    .Deferred(function (n) {
                      t[0][3].add(a(0, n, v(i) ? i : I, n.notifyWith)),
                        t[1][3].add(a(0, n, v(e) ? e : I)),
        ...
        special: {
          ...
          click: {
            ...
            trigger: function (e) {
              var t = this || e;
              return (
                ye.test(t.type) && t.click && j(t, "input") && qe(t, "click"),
                !0
              );
            },
            _default: function (e) {
      ...
      function Be(e, t, n, r) {
        ...
        if (
          ...
          for (s = (a = k.map(xe(i, "script"), $e)).length; f < d; f++)
            (u = i),
              f !== p &&
          ...
          if (s)
            for (
              l = a[a.length - 1].ownerDocument, k.map(a, Ie), f = 0;
              f < s;
              f++
            )
              (u = a[f]),
      ...
      k.ajaxSetup({
        ...
        k.each(["top", "left"], function (e, t) {
          k.cssHooks[t] = Ye(m.pixelPosition, function (e, n) {
            if (n)
              return (n = Xe(e, t)), Fe.test(n) ? k(e).position()[t] + "px" : n;
          });
        }),
  ...
  78: function (e, t, n) {
    ...
    var r = n(20);
    n(19);
    const i = browser.i18n.getMessage("networkErr"),
      o = 1024,
      a = Symbol(),
      s = Symbol(),
      u = 800,
            ...
            .then(function (t) {
              "ok" == t.status
                ? (l(".dict-description").length > 0 &&
                  ...
                  l(".wiki-link-wrapper").length > 0 &&
                    l(".wiki-link-wrapper").remove(),
                  (function (e, t) {
                    let n;
                    try {
                      n = JSON.parse(e.data);
                ...
                browser.runtime.lastError &&
                  A(browser.runtime.lastError.message);
            });
        })(n);
      } catch (e) {
    ...
    function N(e, t, n) {
      ...
      browser.runtime
        ...
        .then(function (r) {
          ...
          browser.runtime.lastError && A(browser.runtime.lastError.message);
        });
    }
    function A(e) {
    ...
    browser.storage.sync
      .get({ isDirectTranslate: !1, isAutoSWT: !0, audioApi: 0, audioSpeed: 5 })
      .then(function (e) {
