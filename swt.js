!(function(e) {
    ...
    /*! layer mobile-v2.0 弹层组件移动版 License LGPL http://layer.layui.com/mobile By 贤心 */ !(function(
      ...
      (d.prototype.view = function() {
        ...
        (i.layer = {
          ...
          closeAll: function() {
            for (var e = o[a](f[0]), t = 0, n = e.length; n > t; t++)
  ...
  16: function(e, t, n) {
              ...
              (function() {
                setTimeout(function() {
                  let e,
                    ...
                    o = "";
                  try {
                    (t = (e = getSelection()).toString()) &&
                      ((r =
                        (n = e.getRangeAt(0).getBoundingClientRect()).x +
                        n.width),
                      (i = n.y + n.height)),
                  ...
                  if (0 != l(".cyxy-trs-result").length) {
                    if ((l("#cyxy-swt-pre").remove(), f)) f = !1;
                      ...
                      (l(".cyxy-trs-result").remove(),
                      l("audio.cyxy-audio").remove(),
                      t && -1 == o.indexOf("cyxy-trs-target") && p)
                    )
                      try {
                        m(e) || N(t, r, i);
                      } catch (e) {
                    ...
                    (0 != l("#cyxy-swt-pre").length &&
                      l("#cyxy-swt-pre").remove(),
                    t && -1 == o.indexOf("cyxy-trs-target") && p)
                  )
                    try {
                      m(e) || N(t, r, i);
      ...
      document.addEventListener(
        ...
        function(e) {
          ...
          "img" == t.tagName.toLowerCase() &&
            ...
            (l(".wiki-img").remove(), l(".wiki-data").removeClass("has-pic")),
            "img" == t.tagName.toLowerCase() &&
              null != t.parentNode &&
    ...
    function x(e, t, n, r) {
      (function(e, t, n, r) {
        ...
        l("body").append(
          ...
          l(".cyxy-trs-result").append('<div class="trs-header"></div>'),
          l(".trs-header").append(`<div class="trs-word">${n}</div>`),
          l(".trs-header").append(
          ...
          r &&
            l(".cyxy-trs-result").append(
              `<div class="trs-sentence">${r}</div>`
            ),
          l(".cyxy-trs-result").mousedown(function() {
            f = !0;
          });
      })(e, t, (n = v(n)), r),
        (function(e, t) {
          let n = chrome.extension.getURL("images/logo_64.png"),
            r = null;
          d ||
            (l("body").append(`<div id="cyxy-swt-pre"><img src="${n}"></div>`),
            l("#cyxy-swt").hide(),
            l("#cyxy-swt-pre")
              .on("mouseenter", () => {
                r = setTimeout(() => {
            ...
            (function(e, t) {
              ...
              l("#cyxy-swt-pre").css({
                ...
                l("#cyxy-swt-pre").offset().left + 20 >= r &&
                  l("#cyxy-swt-pre").css({ left: `${e - 20}px` }),
                l("#cyxy-swt-pre").offset().top + 20 - o >= n &&
                  l("#cyxy-swt-pre").css({ top: `${t + o - i - 23}px` });
            })(e, t));
        })(e, t),
        D("showSWTview", document.URL);
    }
    function b() {
    ...
    function w() {
      ...
      t + o + 20 >= r + e &&
        t > o + s &&
        l(".cyxy-trs-result").css({ top: `${t - o - s}px` }),
        n + a + 20 >= i && l(".cyxy-trs-result").css({ left: `${n - a}px` }),
        l(".cyxy-trs-result").css({ visibility: "visible" });
    }
    let T, C;
    function E(e) {
      ...
      l(".trs-header").append(`<img src="${t}" class="sound-play">`),
        (function(e) {
          let t, n, r, i, o, u;
          "jp" === j(e) ? ((o = "&le=jp"), (u = "jp")) : ((o = ""), (u = "en")),
            (t = encodeURI(e)),
            (n = '<audio class="cyxy-audio" id="cyxy-trs-audio"></audio>'),
            h === a
              ? (r = `<source src="http://dict.youdao.com/dictvoice?audio=${t}${o}" type="audio/mpeg">`)
              : h === s &&
                ((r = `<source src="http://tts.baidu.com/text2audio?lan=${u}&ie=UTF-8&spd=${y}&text=${t}" type="audio/mpeg">`),
                (i = `<embed height="0" width="0" src="http://tts.baidu.com/text2audio?lan=${u}&ie=UTF-8&spd=${y}&text=${t}">`)),
            l("#cyxy-swt").append(
              '<audio class="cyxy-audio" id="cyxy-trs-audio"></audio>'
            ),
            l("audio.cyxy-audio").append(r),
            h === s && l("audio.cyxy-audio").append(i);
        })(e),
        (T = document.getElementById("cyxy-trs-audio")),
        (function e() {
          setTimeout(function() {
            let t = T.duration;
            isNaN(t)
      ...
      try {
        !(function(e, t) {
          ...
          chrome.runtime.sendMessage(
            ...
            function(t) {
              "ok" == t.status
                ? (l(".dict-description").length > 0 &&
                    l(".dict-description").remove(),
                  l(".wiki-data").length > 0 && l(".wiki-data").remove(),
                  l(".trs-pron").length > 0 && l(".trs-pron").remove(),
                  l(".wiki-link").length > 0 && l(".wiki-link").remove(),
                  l(".sound-play").length > 0 && l(".sound-play").remove(),
                  (function(e, t) {
                    let n;
                    try {
                      n = JSON.parse(e.data);
                          ...
                          !(function(e) {
                            ...
                            i &&
                              "http://www.caiyunapp.com/imgs/link_default_img.png" !=
                                i &&
                              (l(".wiki-data").append(
                                `<div class="wiki-img">                <img class="cyxy-wiki" src="${i}" alt="Sorry,the server error!">                </div>`
                              ),
                              l(".wiki-data").addClass("has-pic")),
                              l(".wiki-data").append(
                                '<div class="wiki-item"></div>'
                              );
                            for (let e in t)
                              l(".wiki-item").append(`<p>${t[e]}</p>`);
                            l(".wiki-data").append(
                            ...
                            for (let e in n)
                              n[e] &&
                                "null" != n[e] &&
                                l(".wiki-description").append(`<p>${n[e]}</p>`);
                            l(".cyxy-trs-result").append(
                              `<a href="${r}" target="_blank" class="wiki-link">${r}</a>`
                            );
                          })(t);
                        } catch (e) {
    ...
    function D(e, t) {
      chrome.runtime.sendMessage({ type: e, direction: t });
    }
    function j(e) {
      try {
    ...
    /*! jQuery v3.4.1 | (c) JS Foundation and other contributors | jquery.org/license */ !(function(
      ...
      var N = (function(e) {
        ...
        (se.attr = function(e, t) {
          ...
          var i = r.attrHandle[t.toLowerCase()],
            o =
              i && D.call(r.attrHandle, t.toLowerCase()) ? i(e, t, !y) : void 0;
          return void 0 !== o
            ? o
            : n.attributes || !y
            ? e.getAttribute(t)
              ...
              (g = S(
                ...
                (l = function(e, t, n, a, l) {
                  ...
                  for (
                    ...
                    if (u && f) {
                      for (
                        h = 0, t || f.ownerDocument === p || (d(f), (n = !y));
                        (g = i[h++]);
          ...
          function(e, t) {
            E.fn[e] = function(n, r) {
              ...
              return (
                ...
                1 < this.length &&
                  (_[e] || E.uniqueSort(i), R.test(e) && i.reverse()),
                this.pushStack(i)
              );
            };
          }
            ...
            for (c = (t = (t || "").match(I) || [""]).length; c--; )
              if (
                ...
                a &&
                  ...
                  delete u[p]);
              } else for (p in u) E.event.remove(e, p + t[c], n, r, !0);
      ...
      function Be(e, t, n, r) {
        ...
        var i,
          ...
          h = t[0],
          y = v(h);
        if (y || (1 < d && "string" == typeof h && !m.checkClone && He.test(h)))
        ...
        if (
          ...
          for (s = (a = E.map(xe(i, "script"), $e)).length; f < d; f++)
            (u = i),
              f !== p &&
              ...
              (u = a[f]),
                me.test(u.type || "") &&
                  ...
                  (u.src && "module" !== (u.type || "").toLowerCase()
                    ...
                    : w(u.textContent.replace(Re, ""), u, l));
        }
        return e;
      }
      function We(e, t, n) {
            ...
            if ((u = !E.isEmptyObject(t)) || !E.isEmptyObject(p))
              ...
              p))
                u ||
                  ...
                  y && he([e], !0),
                  d.done(function() {
                    for (r in (y || he([e]), Z.remove(e, "fxshow"), p))
                      E.style(e, r, p[r]);
                  })),
                  (u = yt(y ? g[r] : 0, r, d)),
                  r in g ||
      ...
      E.ajaxSetup({
        ...
        (m.createHTMLDocument =
          (((Jt = a.implementation.createHTMLDocument("").body).innerHTML =
            "<form></form><form></form>"),
        ...
        E.each(["top", "left"], function(e, t) {
          E.cssHooks[t] = Ye(m.pixelPosition, function(e, n) {
            if (n)
              return (n = Xe(e, t)), Fe.test(n) ? E(e).position()[t] + "px" : n;
          });
        }),
