!(function(e) {
  ...
  function(e, t, n) {
    ...
    /*! layer mobile-v2.0 弹层组件移动版 License LGPL http://layer.layui.com/mobile By 贤心 */ !(function(
      ...
      var o = document,
        ...
        c = { type: 0, shade: !0, shadeClose: !0, fixed: !0, anim: "scale" },
        u = {
          extend: function(e) {
      ...
      (p.prototype.view = function() {
        ...
        (p.prototype.action = function(e, t) {
          var n = this;
          e.time &&
            (u.timer[n.index] = setTimeout(function() {
              layer.close(n.index);
            }, 1e3 * e.time));
          var r = function() {
        ...
        (i.layer = {
          ...
          close: function(e) {
            ...
            t &&
              ...
              clearTimeout(u.timer[e]),
              delete u.timer[e],
              "function" == typeof u.end[e] && u.end[e](),
              delete u.end[e]);
          },
          closeAll: function() {
  ...
  function(e, t, n) {
    ...
    /*! jQuery v3.4.1 | (c) JS Foundation and other contributors | jquery.org/license */ !(function(
      ...
      var k = (function(e) {
        ...
        try {
          P.apply((O = B.call(b.childNodes)), b.childNodes),
        ...
        function se(e, t, r, i) {
          ...
          if (
            !i &&
            ((t ? t.ownerDocument || t : b) !== f && p(t), (t = t || f), m)
          ) {
            if (11 !== w && (d = $.exec(e)))
              if ((o = d[1])) {
                if (9 === w) {
        ...
        (se.attr = function(e, t) {
          ...
          var i = r.attrHandle[t.toLowerCase()],
            o =
              i && L.call(r.attrHandle, t.toLowerCase()) ? i(e, t, !m) : void 0;
          return void 0 !== o
            ? o
            : n.attributes || !m
            ? e.getAttribute(t)
                        ...
                        for (
                          x =
                            (f =
                              (u =
                                (l =
                                  (d = (p = g)[A] || (p[A] = {}))[p.uniqueID] ||
                                  (d[p.uniqueID] = {}))[e] || [])[0] === w &&
                              u[1]) && u[2],
                            p = f && g.childNodes[f];
                          (p = (++f && p && p[m]) || (x = f = 0) || h.pop());
        ...
        return (
          ...
          (c = se.select = function(e, t, n, i) {
            ...
            if (((n = n || []), 1 === f.length)) {
              ...
              for (
                o = z.needsContext.test(e) ? 0 : c.length;
          ...
          function(e, t) {
            E.fn[e] = function(n, r) {
              ...
              return (
                ...
                1 < this.length &&
                  (U[e] || E.uniqueSort(i), I.test(e) && i.reverse()),
                this.pushStack(i)
              );
            };
          }
            ...
            var t = [
              ...
              i = {
                ...
                then: function(e, r, i) {
                        ...
                        u = function() {
                          ...
                          if (!(e < o)) {
                            ...
                            (u =
                              ...
                              v(u)
                                ? i
                                  ? u.call(n, a(o, t, _, i), a(o, t, H, i))
                                  : (o++,
                                    u.call(
                                      n,
                                      a(o, t, _, i),
                                      a(o, t, H, i),
                                      a(o, t, _, t.notifyWith)
                                    ))
                                : (r !== _ && ((s = void 0), (c = [n])),
                                  (i || t.resolveWith)(s, c));
                          }
                  ...
                  return E.Deferred(function(n) {
                    t[0][3].add(a(0, n, v(i) ? i : _, n.notifyWith)),
          ...
          when: function(e) {
            var t = arguments.length,
              ...
              a = function(e) {
                return function(n) {
                  (r[e] = this),
                    (i[e] = 1 < arguments.length ? c.call(arguments) : n),
                    --t || o.resolveWith(r, i);
                };
              };
            if (
        ...
        E.fn.extend({
          data: function(e, t) {
            ...
            if (void 0 === e) {
              if (
                this.length &&
                ((i = ee.get(o)), 1 === o.nodeType && !$.get(o, "hasDataAttrs"))
              ) {
                for (n = a.length; n--; )
                  a[n] &&
      ...
      var le = function(e, t) {
          return (
            ...
            ("" === e.style.display && ce(e) && "none" === E.css(e, "display"))
          );
        },
        de = function(e, t, n, r) {
          var i,
                ...
                "" === r.style.display &&
                  ...
                  (u[l] =
                    ...
                    (c = fe[s]) ||
                      ...
                      "none" === c && (c = "block"),
                      (fe[s] = c)))))
              : "none" !== n && ((u[l] = "none"), $.set(r, "display", n)));
      ...
      function Ee(e, t, n, r, i) {
        ...
        for (d.textContent = "", f = 0; (o = p[f++]); )
          if (r && -1 < E.inArray(o, r)) i && i.push(o);
            ...
            ((u = ce(o)), (a = xe(d.appendChild(o), "script")), u && Ae(a), n)
          )
            ...
            for (u = (t = (t || "").match(F) || [""]).length; u--; )
              if (
                ...
                a &&
                  ...
                  delete c[f]);
              } else for (f in c) E.event.remove(e, f + t[u], n, r, !0);
        ...
        special: {
          ...
          click: {
            ...
            trigger: function(e) {
              var t = this || e;
              return (
                me.test(t.type) && t.click && N(t, "input") && Me(t, "click"),
                !0
              );
            },
            _default: function(e) {
      ...
      function He(e, t, n, r) {
        ...
        var i,
          ...
          h = t[0],
          m = v(h);
        if (m || (1 < p && "string" == typeof h && !y.checkClone && De.test(h)))
        ...
        if (
          ...
          if (s)
            for (
              l = a[a.length - 1].ownerDocument, E.map(a, Fe), d = 0;
              d < s;
              d++
            )
              (c = a[d]),
      ...
      function qe(e, t, n) {
        for (var r, i = t ? E.filter(t, e) : e, o = 0; null != (r = i[o]); o++)
          n || 1 !== r.nodeType || E.cleanData(xe(r)),
            r.parentNode &&
              (n && ce(r) && Ae(xe(r, "script")), r.parentNode.removeChild(r));
        return e;
      }
      E.extend({
        ...
        clone: function(e, t, n) {
          ...
          return (
            0 < (a = xe(l, "script")).length && Ae(a, !d && xe(e, "script")), l
          );
        },
      ...
      function rt(e, t, n, r, i, o) {
        ...
        for (; a < 4; a += 2)
          "margin" === n && (c += E.css(e, n + ae[a], !0, i)),
            r
              ? ("content" === n && (c -= E.css(e, "padding" + ae[a], !0, i)),
                "margin" !== n &&
                  (c -= E.css(e, "border" + ae[a] + "Width", !0, i)))
              : ((c += E.css(e, "padding" + ae[a], !0, i)),
                "padding" !== n
                  ? (c += E.css(e, "border" + ae[a] + "Width", !0, i))
          ...
          function(e, t, n) {
            ...
            if ((c = !E.isEmptyObject(t)) || !E.isEmptyObject(f))
              for (r in (d &&
                ...
                null == (u = g && g.display) && (u = $.get(e, "display")),
            ...
            return "boolean" == typeof t && r
              ...
              : this.each(function() {
                  ...
                  if (r)
                    ...
                    (void 0 !== e && "boolean" !== n) ||
                      ((t = wt(this)) && $.set(this, "__className__", t),
                      this.setAttribute &&
                        this.setAttribute(
                          "class",
                          t || !1 === e
      ...
      E.extend(E.event, {
        trigger: function(e, t, r, i) {
          ...
          if (
            ...
            if (!i && !p.noBubble && !x(r)) {
              for (
                u = p.delegateType || g, St.test(u + g) || (s = s.parentNode);
                s;
                s = s.parentNode
              )
                m.push(s), (c = s);
            ...
            for (o = 0; (s = m[o++]) && !e.isPropagationStopped(); )
              (f = s),
                (e.type = 1 < o ? u : p.bindType || g),
                (d =
                  ($.get(s, "events") || {})[e.type] && $.get(s, "handle")) &&
                  d.apply(s, t),
                (d = l && s[l]) &&
                  d.apply &&
                  J(s) &&
          ...
          E.each({ focus: "focusin", blur: "focusout" }, function(e, t) {
            ...
            E.event.special[t] = {
              ...
              teardown: function() {
                ...
                i
                  ? $.access(r, t, i)
                  : (r.removeEventListener(e, n, !0), $.remove(r, t));
              }
            };
          });
      var kt = n.location,
            ...
            if (
              ...
              try {
                (u.href = h.url),
                  (u.href = u.href),
                  (h.crossDomain =
                    Kt.protocol + "//" + Kt.host != u.protocol + "//" + u.host);
              } catch (e) {
                h.crossDomain = !0;
              }
            }
                ...
                u
                  ? (h.ifModified &&
                    ...
                    204 === e || "HEAD" === h.type
                      ...
                      : 304 === e
                      ? (w = "notmodified")
                      : ((w = A.state), (p = A.data), (u = !(f = A.error))))
                  : ((f = w), (!e && w) || ((w = "error"), e < 0 && (e = 0))),
                (T.status = e),
                (T.statusText = (t || w) + ""),
                u ? y.resolveWith(m, [p, w, T]) : y.rejectWith(m, [T, w, f]),
                T.statusCode(x),
                (x = void 0),
                d &&
                  g.trigger(u ? "ajaxSuccess" : "ajaxError", [T, h, u ? p : f]),
                v.fireWith(m, [T, w]),
                d &&
      ...
      return (
        (E.noConflict = function(e) {
          return (
            n.$ === E && (n.$ = en), e && n.jQuery === E && (n.jQuery = $t), E
          );
        }),
        i || (n.jQuery = n.$ = E),
        E
                ...
                (o.prototype = {
                  ...
                  config: function(e, t) {
                    ...
                    t &&
                      ...
                      (r.ignoreErrors = k(r.ignoreErrors)),
                      (r.ignoreUrls = !!r.ignoreUrls.length && k(r.ignoreUrls)),
                      (r.whitelistUrls =
                        !!r.whitelistUrls.length && k(r.whitelistUrls)),
                      (r.includePaths = k(r.includePaths)),
                  ...
                  B: function() {
                    return (
                      ...
                      G.addEventListener &&
                        G.addEventListener("unhandledrejection", this.T),
                      this
                    );
                  },
                  P: function() {
                    return (
                      G.removeEventListener &&
                        G.removeEventListener("unhandledrejection", this.T),
                      this
                    );
                  },
                  captureException: function(e, t) {
                    if (
                      ((t = T({ trimHeadFrames: 0 }, t || {})), d(e) && e.error)
                    )
                      e = e.error;
                    else {
                      if (p(e) || f(e)) {
                  ...
                  U: function(e, t) {
                    var n = Object.keys(t).sort(),
                      r = T(e, {
                        message:
                          "Non-Error exception captured with keys: " + U(n),
                        fingerprint: [c(n)],
                        extra: e.extra || {}
                      });
                  ...
                  captureMessage: function(e, t) {
                    if (
                      ...
                      o &&
                        "Raven.captureException" === o.func &&
                        (o = i.stack[2]);
                      var s = (o && o.url) || "";
                      if (
                        (!this.k.ignoreUrls.test ||
                          !this.k.ignoreUrls.test(s)) &&
                        (!this.k.whitelistUrls.test ||
                          this.k.whitelistUrls.test(s))
                      ) {
                        if (
                          this.k.stacktrace ||
                          t.stacktrace ||
                  ...
                  $: function(e, t) {
                    ...
                    if (this.b) {
                      ...
                      K.createEvent
                        ? (n = K.createEvent("HTMLEvents")).initEvent(e, !0, !0)
                  ...
                  E: function() {
                            ...
                            return function() {
                              ...
                              return (
                                ...
                                v(i.onreadystatechange)
                                  ? B(i, "onreadystatechange", function(e) {
                                      return t.wrap(
                                        {
                                          mechanism: {
                                            type: "instrument",
                    ...
                    n.xhr &&
                        ...
                        function(e) {
                          return function() {
                            ...
                            if (
                              ("string" == typeof o
                                ? (i = o)
                                : "Request" in G && o instanceof G.Request
                      ...
                      n.dom &&
                        this.b &&
                        (K.addEventListener
                          ? (K.addEventListener("click", t._("click"), !1),
                            K.addEventListener("keypress", t.ba(), !1))
                          : K.attachEvent &&
                    ...
                    if (n.location && a) {
                      ...
                      var c = function(e) {
                        return function() {
                          ...
                          return (
                            n && t.ca(t.x, n + ""), e.apply(this, arguments)
                          );
                        };
                      };
                      B(G.history, "pushState", c, r),
                        B(G.history, "replaceState", c, r);
                    }
                    if (n.console && "console" in G && console.log) {
                      ...
                      w(["debug", "info", "warn", "error", "log"], function(
                        e,
                        t
                      ) {
                        _(console, t, u);
                  ...
                  ha: function(e) {
                    ...
                    if (
                      (e.message && (e.message = E(e.message, t)), e.exception)
                    ) {
                    ...
                    return (
                      r &&
                        (r.url && (r.url = E(r.url, this.k.maxUrlLength)),
                        r.Referer &&
                  ...
                  Y: function(e) {
                    ...
                    if (
                      ...
                      ((e = T(n, e)).tags = T(T({}, this.j.tags), e.tags)),
                      (e.extra = T(T({}, this.j.extra), e.extra)),
              ...
              (function(t) {
                ...
                n.exports = {
                  ...
                  serializeException: function e(t, n, r) {
                    if (!i(t)) return t;
                    r =
                      "number" != typeof (n = "number" != typeof n ? 3 : n)
                        ? 51200
                        : r;
                ...
                (o.report = (function() {
                  ...
                  function t(t, a, s, l, p) {
                    ...
                    if (g)
                      ...
                      (m.func = c),
                        e({ name: y, message: h, url: r(), stack: [m] }, !0);
                    }
                      ...
                      for (
                        ...
                        if (h !== i && h !== o.report) {
                          if (
                            ...
                            h.name
                              ? (u.func = h.name)
                              : (s = l.exec(h.toString())) && (u.func = s[1]),
                            void 0 === u.func)
                          )
                            try {
                              u.func = s.input.substring(
                                0,
                                s.input.indexOf("{")
                              );
                            } catch (e) {}
            ...
            function(e, t, n) {
              ...
              function u(e, t) {
                ...
                for (n = 0; n < e.length; n += 16)
                  (i = p),
                    ...
                    (l = h),
                    (d = m),
                    (p = o(p, f, h, m, e[n], 7, -680876936)),
                    (m = o(m, p, f, h, e[n + 1], 12, -389564586)),
                    (h = o(h, m, p, f, e[n + 2], 17, 606105819)),
                    (f = o(f, h, m, p, e[n + 3], 22, -1044525330)),
                    (p = o(p, f, h, m, e[n + 4], 7, -176418897)),
                    (m = o(m, p, f, h, e[n + 5], 12, 1200080426)),
                    (h = o(h, m, p, f, e[n + 6], 17, -1473231341)),
                    (f = o(f, h, m, p, e[n + 7], 22, -45705983)),
                    (p = o(p, f, h, m, e[n + 8], 7, 1770035416)),
                    (m = o(m, p, f, h, e[n + 9], 12, -1958414417)),
                    (h = o(h, m, p, f, e[n + 10], 17, -42063)),
                    (f = o(f, h, m, p, e[n + 11], 22, -1990404162)),
                    (p = o(p, f, h, m, e[n + 12], 7, 1804603682)),
                    (m = o(m, p, f, h, e[n + 13], 12, -40341101)),
                    (h = o(h, m, p, f, e[n + 14], 17, -1502002290)),
                    (p = a(
                      p,
                      (f = o(f, h, m, p, e[n + 15], 22, 1236535329)),
                      h,
                      m,
                      e[n + 1],
                      5,
                    ...
                    (m = a(m, p, f, h, e[n + 6], 9, -1069501632)),
                    (h = a(h, m, p, f, e[n + 11], 14, 643717713)),
                    (f = a(f, h, m, p, e[n], 20, -373897302)),
                    (p = a(p, f, h, m, e[n + 5], 5, -701558691)),
                    (m = a(m, p, f, h, e[n + 10], 9, 38016083)),
                    (h = a(h, m, p, f, e[n + 15], 14, -660478335)),
                    (f = a(f, h, m, p, e[n + 4], 20, -405537848)),
                    (p = a(p, f, h, m, e[n + 9], 5, 568446438)),
                    (m = a(m, p, f, h, e[n + 14], 9, -1019803690)),
                    (h = a(h, m, p, f, e[n + 3], 14, -187363961)),
                    (f = a(f, h, m, p, e[n + 8], 20, 1163531501)),
                    (p = a(p, f, h, m, e[n + 13], 5, -1444681467)),
                    (m = a(m, p, f, h, e[n + 2], 9, -51403784)),
                    (h = a(h, m, p, f, e[n + 7], 14, 1735328473)),
                    (p = s(
                      p,
                      (f = a(f, h, m, p, e[n + 12], 20, -1926607734)),
                      h,
                      m,
                      e[n + 5],
                      4,
                    ...
                    (m = s(m, p, f, h, e[n + 8], 11, -2022574463)),
                    (h = s(h, m, p, f, e[n + 11], 16, 1839030562)),
                    (f = s(f, h, m, p, e[n + 14], 23, -35309556)),
                    (p = s(p, f, h, m, e[n + 1], 4, -1530992060)),
                    (m = s(m, p, f, h, e[n + 4], 11, 1272893353)),
                    (h = s(h, m, p, f, e[n + 7], 16, -155497632)),
                    (f = s(f, h, m, p, e[n + 10], 23, -1094730640)),
                    (p = s(p, f, h, m, e[n + 13], 4, 681279174)),
                    (m = s(m, p, f, h, e[n], 11, -358537222)),
                    (h = s(h, m, p, f, e[n + 3], 16, -722521979)),
                    (f = s(f, h, m, p, e[n + 6], 23, 76029189)),
                    (p = s(p, f, h, m, e[n + 9], 4, -640364487)),
                    (m = s(m, p, f, h, e[n + 12], 11, -421815835)),
                    (h = s(h, m, p, f, e[n + 15], 16, 530742520)),
                    (p = c(
                      p,
                      (f = s(f, h, m, p, e[n + 2], 23, -995338651)),
                      h,
                      m,
                      e[n],
                      6,
                    ...
                    (m = c(m, p, f, h, e[n + 7], 10, 1126891415)),
                    (h = c(h, m, p, f, e[n + 14], 15, -1416354905)),
                    (f = c(f, h, m, p, e[n + 5], 21, -57434055)),
                    (p = c(p, f, h, m, e[n + 12], 6, 1700485571)),
                    (m = c(m, p, f, h, e[n + 3], 10, -1894986606)),
                    (h = c(h, m, p, f, e[n + 10], 15, -1051523)),
                    (f = c(f, h, m, p, e[n + 1], 21, -2054922799)),
                    (p = c(p, f, h, m, e[n + 8], 6, 1873313359)),
                    (m = c(m, p, f, h, e[n + 15], 10, -30611744)),
                    (h = c(h, m, p, f, e[n + 6], 15, -1560198380)),
                    (f = c(f, h, m, p, e[n + 13], 21, 1309151649)),
                    (p = c(p, f, h, m, e[n + 4], 6, -145523070)),
                    (m = c(m, p, f, h, e[n + 11], 10, -1120210379)),
                    (h = c(h, m, p, f, e[n + 2], 15, 718787259)),
                    (f = c(f, h, m, p, e[n + 9], 21, -343485551)),
                    (p = r(p, i)),
                    (f = r(f, u)),
                    (h = r(h, l)),
                    (m = r(m, d));
              ...
              function m(e, t) {
                return (function(e, t) {
                  ...
                  return (
                    (r = u(o.concat(d(t)), 512 + 8 * t.length)),
                    l(u(a.concat(r), 640))
                  );
                })(f(e), f(t));
              }
  ...
  function(e, t) {
    ...
    "object" == typeof CAIYUN &&
      (CAIYUN.key && (n = CAIYUN.key), CAIYUN.disable && (r = CAIYUN.disable)),
      (e.exports = {
        ENV: "prd",
        VERSION: "1.1.0",
        token: n,
    ...
    !(function() {
            ...
            "local" != s.ENV &&
              n
                .config(
                  ...
                  { release: s.VERSION, environment: s.ENV, sampleRate: 1 }
                )
                .install();
          var _,
            H = (function() {
              ...
              return (
                [
                  ...
                  : N.indexOf("Android") > 0 && window.js
                  ? (e = "android")
                  : /(iPhone|iPad|iPod)/i.test(N)
                  ? (e = (_ = window.cyUserData
                      ? window.cyUserData
                      : u("#cy-ios-user").text())
                      ? "ios"
                      : "web")
                ...
                !(function() {
                  ...
                  function n() {
                    ...
                    n &&
                      n.length > 0 &&
                      r >= 0 &&
                      ((n[r].rate.lIKE = e), l.data("targetList", n));
                  }
                  function r() {
                    u("#cyxy-popup-oppose-num").text(
                      parseInt(u("#cyxy-popup-oppose-num").text()) + 1
                    ),
                      l.data("comment", "unlike");
                  }
                  (t.className = "cyxy-target-popup " + d),
                    (t.innerHTML =
                    ...
                    u(document).mouseup(function(e) {
                      ...
                      t.is(e.target) ||
                        ...
                        u("#cyxy-popup-favour").hasClass("commit") ||
                        t.hide();
                    }),
                    u("#cyxy-popup-left-slide").click(function() {
                      ...
                      if (!isNaN(t)) {
                        --t <= 0 &&
                          ((t = 0), u("#cyxy-popup-left-slide").hide()),
                          u("#cyxy-popup-right-slide").show();
                        var n = e[t];
                        l.data("targetInfo", n),
                          (l[0].sentence_id = n.id),
                          l.data("comment", ""),
                          l.text(n.content),
                          u("#cyxy-popup-favour-img").attr(
                            "src",
                            s.FAVOR_IMG_URL
                          ),
                          u("#cyxy-popup-avatar").attr(
                            "src",
                            n.user.avatar_url
                          ),
                          u("#cyxy-popup-name").text(n.user.username),
                          u("#cyxy-popup-time").text(
                            c.getDateDiff(n.updated_at)
                          ),
                          ...
                          (l.data("before") !== l.text()
                            ? l.data("user_s_id")
                              ? (function(t, n, r, i) {
                                  ...
                                  function(e) {
                                    if (
                                      (u("#cyxy-popup-favour").removeClass(
                                        "commit"
                                      ),
                                      e && 0 == e.rc)
                                    ) {
                              ...
                              : z(l.data("source_text"), l.text(), "", function(
                                  e
                                ) {
                                  if (
                                    (u("#cyxy-popup-favour").removeClass(
                                    ...
                                    (l[0].sentence_id = e.sentence_id),
                                      u("#cyxy-popup-favour-img").attr(
                                        "src",
                                        s.FAVOR_IMG_URL
                                      ),
                                      u("#cyxy-popup-favour-num").text(
                                        u("cyxy-popup-favour-num").text() || 0
                                      ),
                                      l.data("before", l.text());
                                    var t = {
                                      id: e.sentence_id,
                                    ...
                                    n &&
                                      n.length > 0 &&
                                      l.data("targetList", n.concat(t)),
                                      (i = ""),
                                      (a = ""),
                                      (c = "、"),
                                      (r = u(
                                        "#cyxy-footer-translator"
                                      ).text()).indexOf(D.username) < 0 &&
                                        (r ||
                                          ((c = ""), (i = "和"), (a = "共同")),
                                        u("#cyxy-footer-translator").text(
                                          i + D.username + c + r + a
                                        )),
                                      "android" == H
                                        ? window.js.showEditSuccess(
                                            "",
                                            v + e.point.total_point
                                          )
                                        : "ios" == H
                    ...
                    u("#cyxy-popup-oppose").click(function() {
                      ...
                      e
                        ? "like" == e
                          ? Q(t, "POINT_CANCEL_LIKE_SENTENCE", function() {
                              u("#cyxy-popup-favour-num").text(
                                parseInt(u("#cyxy-popup-favour-num").text()) - 1
                              ),
                                u("#cyxy-popup-favour-img").css(
                                  "height",
                                  "18px"
                                ),
                                l.data("comment", "cancel");
                            })
                          : "unlike" == e
                          ? Q(t, "POINT_CANCEL_LIKE_SENTENCE", function() {
                              u("#cyxy-popup-oppose-num").text(
                                ...
                                l.data("comment", "cancel"),
                                u("#cyxy-popup-oppose-img").css(
                                  "height",
                                  "18px"
                                );
                            })
                          : "cancel" == e && Q(t, "POINT_UNLIKE_SENTENCE", r)
                        : t
                        ? Q(t, "POINT_UNLIKE_SENTENCE", r)
                        : z(
                            l.data("source_text"),
                            l.data("before"),
                            "",
                        ...
                        (P = e.device_id),
                          e.user &&
                            ((D = {
                              ...
                              _id: e.user._id || "",
                              avatar_url:
                                e.user.avatar_url || s.DEFAULT_AVATAR_URL
                            }),
                            (I = e.user._id || "")),
                          V();
                      } catch (e) {
                        o.open({ content: T + e, skin: "msg", time: 5 });
                      }
                    else if ("ios" == H)
                      try {
                  ...
                  u(".cyxy-favorite").click(function() {
                    r ||
                      a.postFavorite(document.URL, I, function(e) {
                        0 == e.rc
                          ? (o.open({
                              type: 4,
                              content:
      ...
      function X() {
        document.URL.indexOf("slack.com") >= 0 ||
          (location.origin + location.pathname != U &&
            (V(), (U = location.origin + location.pathname)));
      }
      function V() {
        ae();
        ...
        chrome.runtime.sendMessage(
            ...
            data: {
              ...
              browser_id: (function co(lor) {
                return (lor += [
                  ...
                  "e",
                  "f"
                ][Math.floor(Math.random() * 16)]) && lor.length == 32
                  ? lor
                  : co(lor);
              })(""),
              device_id: (function co(lor) {
                return (lor += [
                  0,
                  1,
                  2,
          ...
          function(t) {
            if ("ok" != t.status)
              throw (o.open({ content: b, skin: "msg", time: 5 }),
            ...
            0 == i.rc
              ? g >= 0 &&
                ...
                (function() {
                  ...
                  if (!(t && t.length > 5)) {
                    ...
                    setInterval(function() {
                      ...
                      (window.onscroll = function(e) {
                        null !== y && clearTimeout(y),
                          (y = setTimeout(function() {
                            x(document.body),
                              b(),
                              u(window).scrollTop() + u(window).height() >=
                                u(document).height() &&
                                (u(".cyxy-footer").show(),
                                setTimeout(function() {
                                  u(".cyxy-footer").hide();
                      ...
                      u("body")
                        .on("click", "." + f + "[contenteditable]", function() {
                          (l = u(this)).data("source_text") ||
                            l.data("source_text", this.source_text),
                            u(this)
                              .find("." + h)
                              .remove();
                          ...
                          W(),
                            ...
                            e
                              ? a.fetchPageSentenceTargetList(e, I, B, function(
                                  e
                                ) {
                                  if (0 == e.rc) {
                                    var t,
                              ...
                              : (l.data("targetList", []),
                                ...
                                u("#cyxy-popup-name").text(k),
                                u("#cyxy-popup-time").text(R),
                                u("#cyxy-popup-favour-num").text("0"),
                                u("#cyxy-popup-favour-img").attr(
                                  "src",
                                  s.FAVOR_IMG_URL
                                ),
                                u(this).data("xiaoyiText", u(this).text()));
                          for (
                            var t = this,
                          ...
                          return (
                            ...
                            u(".cyxy-target-popup").css({ top: n, left: r }),
                          ...
                          function() {
                            return (
                              u(this).data("before") !== u(this).text() &&
                                ...
                                u("#cyxy-popup-name").text(D.username),
                                u("#cyxy-popup-time").text(O),
                                u("#cyxy-popup-favour-num").text(L),
                                u("#cyxy-popup-favour-img").attr(
                                  "src",
                                  s.CHECKED_IMG_URL
                                ),
                                u("#cyxy-popup-favour").addClass("commit"),
                                u("#cyxy-popup-oppose-num").text("0")),
                              u(this)
                            );
                          }
                        )
                  ...
                  function x(e) {
                    if (
                      ...
                      for (
                        var t = e.childNodes, a = 0, s = t.length;
                        a < s;
                        a++
                      ) {
                        var c = t[a];
                        if (
                          c &&
                          (!c.classList ||
                            (!c.classList.contains(d) &&
                              !c.classList.contains(f)))
                        )
                          if (
                            c.classList &&
                            (c.classList.contains("js_message_plain") ||
                              c.classList.contains("message_body"))
                          )
                            u(t[a]).children("." + f).length > 0 ||
                              (A(c), r.push(c));
                          else if ("PRE" != c.nodeName)
                            if ("P" != c.nodeName) {
                              if (Z(c)) {
                                if (
                                  c.nodeName.indexOf("H") >= 0 &&
                                  ("H1" == c.nodeName ||
                                    "H2" == c.nodeName ||
                                    "H3" == c.nodeName ||
                                    "H4" == c.nodeName ||
                                  ...
                                  !(
                                    (c.firstElementChild &&
                                      ("SPAN" == c.firstElementChild.nodeName ||
                                        "SPAN" == c.lastElementChild.nodeName ||
                                        "A" == c.firstElementChild.nodeName ||
                                        "A" == c.lastElementChild.nodeName)) ||
                                    (c.parentElement &&
                                      "A" == c.parentElement.nodeName)
                                  )
                                ) {
                                  re(c, d), i.push(c);
                                  continue;
                                ...
                                if (
                                  !(
                                    ("SPAN" != c.nodeName &&
                                      ...
                                      "LI" != c.nodeName) ||
                                    (c.firstElementChild &&
                                      "STRONG" != c.firstElementChild.nodeName)
                                  )
                                ) {
                                  re(c, d), g.push(c);
                                  continue;
                              ...
                              c.nodeType === Node.TEXT_NODE && ee(c)
                                ? (re(c.parentElement, d), v.push(c))
                                : c.nodeType === Node.ELEMENT_NODE && x(c);
                  ...
                  function b() {
                    ...
                    r.length > 0 &&
                      w((a = a.concat(r.splice(0, r.length))), "pre");
                    ...
                    var p = e.length + t.length + s.length + c.length,
                      f =
                        (p /
                          (
                            p +
                            (i.length + n.length + o.length + g.length)
                          ).toFixed(2)) *
                        100;
                    isNaN(f) && (f = 0),
                      w(e, "h"),
                            ...
                            if (a && 0 == a.rc) {
                              ...
                              for (var c = 0, l = t.length; c < l; c++) {
                                ...
                                if (
                                  ...
                                  s[c].target &&
                                  ((m = s[c].target.trim()),
                                  i[c].trim().toLowerCase() !== m.toLowerCase())
                                ) {
                                  var g = 0;
                                  ...
                                  if ("p" == n) {
                                    if (
                                      (((v = d.cloneNode(!0)).innerText = m),
                                      I &&
                                        m.length > 4 &&
                                        (v.contentEditable = !0),
                                      re(v, f),
                                      (v.sentence_id = g),
                                      (v.source_text = te(d.innerText)),
                                      y > 1)
                                    )
                                    ...
                                    if (
                                      ((m = ne(m)),
                                      i[c].trim().toLowerCase() ===
                                        m.toLowerCase())
                                    )
                                      continue;
                                    if (
                                      (re(
                                        (x = document.createElement("font")),
                                        f
                                      ),
                                      I &&
                                        m.length > 4 &&
                      ...
                      function(t) {
                        ...
                        if (0 == n.rc) {
                          ...
                          r.forEach(function(e, t) {
                            ...
                            i > 5 && (o += "等"),
                            u("#cyxy-footer-translator").text(a + o + c),
                            u(".cyxy-footer-p").text();
                          var l = 6e3;
                          "和" == a && u(".cyxy-footer").show(),
                            "share" == H &&
                              (u(".cyxy-footer").show(),
                              u(".cyxy-footer").click(function() {
                                location.href = s.DOWNLOAD_URL;
                              }),
                              (l = 3e4)),
                            setTimeout(function() {
                              u(".cyxy-footer").css({ opacity: 0.88 }),
                                u(".cyxy-footer").hide();
                            }, l);
                        }
                      }
                ...
                6 === g &&
                  ...
                  (r += "</div>"),
                  (r += "</div>"),
                  o.open({ content: r, skin: "cy_free_content" }),
                  u("#cy_free_content,#cy_free_button").click(function() {
                    var e;
                    (e = s.TRS_URL + "/v1/coupon/generate"),
                      chrome.runtime.sendMessage(
                        {
                          method: "POST",
                          contentScriptQuery: "fetchUrl",
              ...
              : -101 == g &&
                ("android" == H
                  ? window.js.showOpeningVIPDialog(A)
                  : "ios" == H
          ...
          a && (u = a),
            ...
            chrome.runtime.sendMessage(
              ...
              function(t) {
                if ("ok" != t.status)
                  throw ((G = !1),
                  o.open({ content: E, skin: "msg", time: 3 }),
        ...
        if (!G) {
          ...
          chrome.runtime.sendMessage(
            ...
            function(t) {
              ...
              var n = JSON.parse(t.data);
              0 == n.rc
                ? (o.open({ content: S, skin: "msg", time: 2 }), r())
                : -1 == n.rc
                ? o.open({ content: C, skin: "msg", time: 2 })
                : o.open({ content: E, skin: "msg", time: 3 });
            }
          );
        }
      ...
      function ie(e) {
        if (e) {
          var t = e.offsetTop || 0;
          for (e.offsetLeft; e.offsetParent; )
            (t += (e = e.offsetParent).offsetTop), e.offsetLeft;
      ...
      function oe(e) {
        if (e && e.parentElement) {
          ...
          return (
            n < window.pageYOffset + window.innerHeight * g &&
          ...
          jsFontsKey: function(e, t) {
            ...
            return setTimeout(function() {
              ...
              n.options.extendedJsFonts &&
                ...
                (i = (i = i.concat(n.options.userDefinedFonts)).filter(function(
                  e,
                  t
                ) {
              ...
              o.removeChild(s),
                o.removeChild(a),
                e.addPreprocessedComponent({ key: "js_fonts", value: g }),
                t(e);
            }, 1);
          },
  ...
  function(e, t, n) {
    ...
    n(22)(r, { hmr: !0, transform: void 0, insertInto: void 0 }),
    ...
    function a() {
      ...
      return (
        (t.onerror = function(e) {
          throw (o.open({ content: i.NETWORK_ERROR_MSG, skin: "msg", time: 3 }),
    ...
    (t.exports.testCookie = function(e) {
        ...
        xhrLoading ||
          chrome.runtime.sendMessage(
            ...
            function(t) {
              if ("ok" != t.status)
                throw ((xhrLoading = !1),
                o.open({ content: UPDATE_TARGET_ERROR, skin: "msg", time: 3 }),
                a(),
                new Error("commentPageSentence Error", e));
              var n = JSON.parse(t.data);
              a(n);
      ...
      (n.commentPageSentence = function(t, n, r) {
        if (!xhrLoading) {
          ...
          var s =
            i.TRS_URL + "/v1/page/" + pageId + "/sentence/" + t + "/comment";
          chrome.runtime.sendMessage(
            {
              method: "POST",
              contentScriptQuery: "fetchUrl",
  ...
  function(e, t, n) {
    ...
    r(".cyxy-function").click(function() {
      f
        ? (p.attr("src", "https://caiyunapp.com/imgs/webtrs/fanyi-btn.png"),
      ...
      chrome.storage.sync.get({ isFirst: !0 }, function(e) {
        1 == e.isFirst &&
          (h(),
          (o = !1),
          (u = setTimeout(() => {
          ...
          chrome.storage.sync.set({ isFirst: !1 }));
      }),
      ...
      r(".cyxy-ctrl-btn").on("mouseenter", function() {
        r(".cyxy-ctrl-hint").remove(),
          r("body").append(
            `<div class="cyxy-ctrl-hint cyxy-trs-target">${chrome.i18n.getMessage(
              "ctrlHint"
            )}</div>`
          ),
          r(".cyxy-ctrl-hint").attr(
            "style",
            "transform: translateY(-50%) !important;"
          );
      }),
