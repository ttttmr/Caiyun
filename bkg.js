! function (e) {
                ...
                (function (t) {
                    ...
                    o.prototype = {
                        ...
                        captureException: function (e, t) {
                            if (t = k({
                                ...
                                if (d(e)) e = e;
                                    ...
                                    if (!g(e)) return this.captureMessage(e, k(t, {
                                        stacktrace: !0,
                                        trimHeadFrames: t.trimHeadFrames + 1
                                    }));
                            ...
                            if (!this.k.ignoreErrors.test || !this.k.ignoreErrors.test(e)) {
                                ...
                                if ((!this.k.ignoreUrls.test || !this.k.ignoreUrls.test(s)) && (!this.k.whitelistUrls.test || this.k.whitelistUrls.test(s))) {
                                    if (this.k.stacktrace || t.stacktrace || "" === r.message) {
                                        r.fingerprint = null == r.fingerprint ? e : r.fingerprint, (t = k({
                                            trimHeadFrames: 0
                                        }, t)).trimHeadFrames += 1;
                                        var c = this.X(i, t);
                                        r.stacktrace = {
                        ...
                        ja: function () {
                            if (this.c || this.b) {
                                var e = {};
                                return this.c && H.userAgent && (e.headers = {
                                    "User-Agent": H.userAgent
                                }), $.location && $.location.href && (e.url = $.location.href), this.b && z.referrer && (e.headers || (e.headers = {}), e.headers.Referer = z.referrer), e
                            }
                        },
                        y: function () {
                        ...
                        Y: function (e) {
                            var t = this.k,
                                ...
                                i = this.ja();
                            if (i && (n.request = i), e.trimHeadFrames && delete e.trimHeadFrames, (e = k(n, e)).tags = k(k({}, this.j.tags), e.tags), e.extra = k(k({}, this.j.extra), e.extra), e.extra["session:duration"] = r() - this.s, this.u && this.u.length > 0 && (e.breadcrumbs = {
                ...
                (function (t) {
                    ...
                    o.report = function () {
                        ...
                        function t(t, a, s, l, h) {
                            ...
                            if (g) o.computeStackTrace.augmentStackTraceWithInitialElement(g, a, s, d), n();
    ...
    function T(e, t, n) {
        if ("showSubByVideoBtn" == e.type) chrome.tabs.query({
            active: !0,
            currentWindow: !0
        }, function (e) {
            if (!e[0]) return;
            ...
            t.match(U) || (w = t, E = e[0].id, n = {
                ...
                if (e) {
                    ...
                    chrome.runtime.lastError.message.includes("permission") ? (alert(chrome.i18n.getMessage("requestReloadAndReload")), chrome.tabs.sendMessage(E, {
                        type: "closeVideoBtn"
                    })) : O(E)
                }
            }))
    ...
    function O(e) {
        ! function (e, t) {
            e = e || (() => {}), t = t || (() => {}), q() ? e() : fetch("https://biz.caiyunapp.com/test_cookies", {
                method: "GET",
                headers: {
                ...
                if (r.cookies && r.cookies.cy_user) {
                    ...
                    if (t.is_login) return M = t._id, v = t.token, D = M, void e()
                }
                chrome.tabs.sendMessage(E, {
                    type: "alert",
    ...
    function F() {
        chrome.webNavigation.onHistoryStateUpdated.addListener(function (e) {
            0 === e.frameId && -1 != E && "" != w && chrome.tabs.get(e.tabId, function (e) {
                w.match(C) && e.id == E && e.url != w && (w = e.url, chrome.tabs.update(E, {
                    url: w
                }))
            })
            ...
            e == S && i && (i.onclose = function () {}, i.close())
        })
    }
    async function W(e) {
    ...
    chrome.browserAction.onClicked.addListener(function (e) {
        e.url.match("^(file:///).+(mp3|mp4|avi|flv|wmv|mov|html)$") && chrome.extension.isAllowedFileSchemeAccess(function (e) {
            if (!e) return alert(chrome.i18n.getMessage("RequireAllowAccessFile")), void chrome.tabs.create({
        ...
        s = !0, chrome.storage.sync.get({
            ...
            e.isFirst && I(), e.version != t.version && setTimeout(function () {}, 3e4)
        }), W()
        ...
        1 != (0 != e.frameId) && chrome.storage.sync.get({
            ...
            c = t.isAutoSWT, u = o.LANG_L[t.transDirect], l = o.SUB_TYPE_l[t.subType], t.isAutoTranslate && (t.isAutoTranslate ? (chrome.browserAction.setBadgeText({
                text: "auto"
            ...
            wav: function (e, t) {
                ...
                if (m("RIFF"), v(36 + f), m("WAVE"), m("fmt "), v(16), g(1), g(1), v(i), v(i * (a / 8)), g(a / 8), g(a), m("data"), v(f), 8 == a)
                    for (u = 0; u < r; u++, d++) {
                        ...
                        for (u = 0; u < r; u++, d += 2) p.setInt16(d, e[u], !0);
                t(new Blob([p], {
                    type: "audio/wav"
                }))
            }
    ...
    Object.defineProperty(t, "__esModule", {
        value: !0
    }), t.Resampler = r, r.prototype.initialize = function () {
